...
class Emergencia{
	...
	private $id_emergencia;

	public function getId_emergencia(){
		return $this->id_emergencia;
	}

	public function setId_emergencia($id_emergencia){
    ...
    public function __construct($array = null){
        if($array){
        	if($array['id_emergencia']){
        		$this->setId_emergencia($array['id_emergencia']);
        	}

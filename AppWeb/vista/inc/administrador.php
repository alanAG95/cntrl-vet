      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="mainMenu">
          <ul class="nav navbar-nav ">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Dueños <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="?modulo=dueño_mascota&accion=listar">Listar Dueños</a></li>
                <li><a href="?modulo=dueño_mascota&accion=editar">Agregar Dueño de mascota</a></li>
              </ul>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="?modulo=usuario&accion=listar">Listar usuarios</a></li>
                <li><a href="?modulo=usuario&accion=editar">Agregar usuario</a></li>
              </ul>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="?modulo=instrumental&accion=editar">Solicitar insumo o instrumental</a></li>
              </ul>
            </li>
          </ul>
